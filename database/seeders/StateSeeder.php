...
class StateSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $states = array(
            ...
            array('name' => "Aïn Defla", 'country_id' => 3),
            array('name' => "Aïn Témouchent", 'country_id' => 3),
            array('name' => "Algiers", 'country_id' => 3),
            array('name' => "Annaba", 'country_id' => 3),
            array('name' => "Batna", 'country_id' => 3),
            array('name' => "Béchar", 'country_id' => 3),
            array('name' => "Béjaïa", 'country_id' => 3),
            array('name' => "Biskra", 'country_id' => 3),
            array('name' => "Blida", 'country_id' => 3),
            array('name' => "Bordj Bou Arréridj", 'country_id' => 3),
            array('name' => "Bouira", 'country_id' => 3),
            array('name' => "Boumerdès", 'country_id' => 3),
            array('name' => "Chlef", 'country_id' => 3),
            array('name' => "Constantine", 'country_id' => 3),
            array('name' => "Djelfa", 'country_id' => 3),
            array('name' => "El Bayadh", 'country_id' => 3),
            array('name' => "El Oued", 'country_id' => 3),
            array('name' => "El Taref", 'country_id' => 3),
            array('name' => "Ghardaïa", 'country_id' => 3),
            array('name' => "Guelma", 'country_id' => 3),
            array('name' => "Illizi", 'country_id' => 3),
            array('name' => "Jijel", 'country_id' => 3),
            array('name' => "Khenchela", 'country_id' => 3),
            array('name' => "Laghouat", 'country_id' => 3),
            array('name' => "M'Sila", 'country_id' => 3),
            array('name' => "Médéa", 'country_id' => 3),
            array('name' => "Mila", 'country_id' => 3),
            array('name' => "Mostaganem", 'country_id' => 3),
            array('name' => "Mascara", 'country_id' => 3),
            array('name' => "Naama", 'country_id' => 3),
            array('name' => "Oran'", 'country_id' => 3),
            array('name' => "Oum el-Bouaghi", 'country_id' => 3),
            array('name' => "Ouargla", 'country_id' => 3),
            array('name' => "Relizane", 'country_id' => 3),
            array('name' => "Saïda", 'country_id' => 3),
            array('name' => "Sétif", 'country_id' => 3),
            array('name' => "Sidi Bel Abbes", 'country_id' => 3),
            array('name' => "Skikda", 'country_id' => 3),
            array('name' => "Souk Ahras", 'country_id' => 3),
            array('name' => "Tamanghasset", 'country_id' => 3),
            array('name' => "Tébessa", 'country_id' => 3),
            array('name' => "Tiaret", 'country_id' => 3),
            array('name' => "Tindouf", 'country_id' => 3),
            array('name' => "Tipasa", 'country_id' => 3),
            array('name' => "Tissemsilt", 'country_id' => 3),
            array('name' => "Tizi Ouzou", 'country_id' => 3),
            array('name' => "Tlemcen", 'country_id' => 3),
            ...
            array('name' => "Escaldes-Engordany", 'country_id' => 5),
            array('name' => "Escaldes-Engordany", 'country_id' => 5),
            ...
            array('name' => "Daerah Istimewa Yogyakarta", 'country_id' => 102),
            array('name' => "DKI Jakarta", 'country_id' => 102),
            ...
            array('name' => "Kalimantan Utara", 'country_id' => 102),
            array('name' => "Kepulauan Riau", 'country_id' => 102),
            array('name' => "Lampung", 'country_id' => 102),
            array('name' => "Maluku", 'country_id' => 102),
            array('name' => "Maluku Utara", 'country_id' => 102),
            array('name' => "Nanggroe Aceh Darussalam", 'country_id' => 102),
